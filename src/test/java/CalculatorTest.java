...
public class CalculatorTest {
    ...
    public void factorialFalsePositive(){
        assertNotEquals("Finding factorial of a number for False Positive", 720, calculator.fact(7), DELTA);
    ...
    public void powerFalsePositive(){
        ...
        assertNotEquals("Finding power for False Positive", -7.3, calculator.power(2, 2), DELTA);
        assertNotEquals("Finding power for False Positive", -7.3, calculator.power(5, 2), DELTA);
        assertNotEquals("Finding power for False Positive", -9.3, calculator.power(9, 2), DELTA);
    }
    ...
    public void sqrootFalsePositive(){
        ...
        assertNotEquals("Finding square root for False Positive", 9, calculator.sqroot(64), DELTA);
        assertNotEquals("Finding square root for False Positive", 10, calculator.sqroot(64), DELTA);
    }
